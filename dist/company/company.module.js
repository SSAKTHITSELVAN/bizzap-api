...
exports.CompanyModule = CompanyModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([company_entity_1.Company, consumed_lead_entity_1.ConsumedLead]),
            chat_module_1.ChatModule,
        ],
        controllers: [company_controller_1.CompanyController, admin_company_controller_1.AdminCompanyController],
