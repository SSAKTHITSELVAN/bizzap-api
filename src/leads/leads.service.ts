...
// import { DealStatus } from './dto/update-consumed-lead-status.dto';
...
//   // Add these methods to leads.service.ts
...
// /**
//  * Update the status of a consumed lead
//  */
...
// /**
//  * Get all consumed leads with status for a specific company
//  */
...
// /**
//  * Get details of a specific consumed lead
//  */
...
// /**
//  * Get all consumed leads with status (Admin only)
//  */
...
// /**
//  * Get consumed leads for a specific company (Admin only)
//  */
...
// /**
//  * Get comprehensive conversion metrics (Admin only)
//  */
...
//   // Get top performing companies (by conversion rate)
...
//     .filter(c => c.totalConsumed >= 3) // At least 3 consumed leads
//     .sort((a, b) => b.conversionRate - a.conversionRate)
//     .slice(0, 10);

//   // Lead quality by lead owner (which companies post high-quality leads)
...
//     },
//     topPerformingCompanies, // Best converters (consumers)
//     leadQualityByCompany,   // Best lead providers (posters)
//     statusBreakdown: {
...
// /**
//  * Get conversion metrics for a specific company (Admin only)
//  */
