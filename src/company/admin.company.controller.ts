...
//   @ApiOperation({ summary: 'Get company count by category' })
//   @ApiResponse({ status: 200, description: 'Company category breakdown retrieved successfully' })
//   async getCompanyCategoryBreakdown() {
//     return {
//       message: 'Company category breakdown retrieved successfully',
//       data: await this.companyService.getCompaniesByCategory(),
//     };
//   }
